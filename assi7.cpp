...
cin >> city_count;city_count = (city_count > MAX_NUM_CITIES) ?
MAX_NUM_CITIES : city_count;
...
cout << city_names[mat[i].start] << " to " << city_names[mat[i].end]
             << " of weight " << mat[i].wt << endl;
}
