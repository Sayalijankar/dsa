...
{ 
    if(temp==NULL) 
        ...
        return(max(height(temp->le ),height(temp->right))+1); 
} 
...
{ 
 ...
 { 
      ...
      { 
           ...
           case 4 : a.deleten(); 
              break; 
           default : cout<<endl<<"Please choose a valid op on (1-4)."; 
      } 
      cout<<endl<<"Would you like to con nue? (y/n):\t"; 
      cin>>c; 
       } 
       while(c=='y'||c=='Y'); 
      cout<<"\n\n// END OF CODE\n\n"; 
